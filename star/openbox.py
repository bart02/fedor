...
class Robot:
    ...
    def open_box(self):
        ...
        time.sleep(1)
        self.sock.send(b'robot:motors:TorsoR:posset:-85\n')
        time.sleep(1)
        ...
        self.fist()
        time.sleep(1)
        self.sock.send(b'robot:motors:L.ShoulderS:posset:110\n')
        time.sleep(1)
        self.antifist()
        self.sock.send(b'robot:motors:L.WristS:posset:20\n')
        time.sleep(1)
        ...
        time.sleep(1)
        self.sock.send(b'robot:motors:L.ShoulderS:posset:65\n')
        time.sleep(1)
        self.sock.send(b'robot:motors:TorsoR:posset:-90\n')
        time.sleep(1)
        self.sock.send(b'robot:motors:L.ElbowR:posset:90\n')
        time.sleep(1)

fedor = Robot('localhost')
